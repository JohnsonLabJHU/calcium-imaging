...
az containerapp job create \
  --name calcium-worker --resource-group YOUR-RESOURCE-GROUP \
  ...
  --image YOUR-ACR.azurecr.io/calcium-worker:v1 \
...
```
az containerapp job start --name calcium-worker --resource-group YOUR-RESOURCE-GROUP
```
...
```
az containerapp job update --name calcium-worker --resource-group YOUR-RESOURCE-GROUP \
  --image YOUR-ACR.azurecr.io/calcium-worker:v2
```
...
| where ContainerGroupName_s startswith 'calcium-worker'
